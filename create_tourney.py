...
def setup_court_schedules(courts):
    ...
    for court in courts:
        #TODO create dict with court info and special list inside for schedule


def schedule_court(player1, player2, sport, courts, time_restriction=[]):
    #TODO use time restriction    
    pass
                ...
                for opponent in players_to_schedule:
                    if not scheduled:
                        ...
                        if len(joint_availability) > 0:
                            ...
                            # TODO pass player schedules and also append to player schedules here 
